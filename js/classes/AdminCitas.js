...
export default class AdminCitas {
    ...
    editar(citaActualizada) {
        this.citas = this.citas.map(cita => cita.id === citaActualizada.id ? citaActualizada : cita); // el foreach solo itera, el map itera y me da un arreglo nuevo
        this.mostrar();
    }
    ...
    mostrar() {
        ...
        this.citas.forEach(cita => {
            ...
            const clone = structuredClone(cita) // el foreach no me da los datos entonces hago un clon para que persista
